<?php
    class Categoria{
        ...
        public function insertar($params){
            $ins = "INSERT INTO categoria(codigo, nombre) VALUES('$params->codigo','$params->nombre')";
        ...
        public function editar($id, $params){
            $editar = "UPDATE categoria SET codigo='$params->codigo', nombre ='$params->nombre' WHERE id_categoria = $id";
        ...
        public function filtro($dato){
            $filtro = "SELECT * FROM categoria WHERE nombre LIKE '%$dato%'ORDER BY nombre";
